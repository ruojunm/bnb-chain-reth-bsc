...
echo ""
echo "🧪 LOCAL TESTING APIs (Use these for reliable local testing):"
echo "   🚀 Working APIs:"
echo "     curl -X POST -H \"Content-Type: application/json\" --data '{\"jsonrpc\":\"2.0\",\"method\":\"bsc_blockNumber\",\"params\":[],\"id\":1}' http://localhost:8545"
echo "     curl -X POST -H \"Content-Type: application/json\" --data '{\"jsonrpc\":\"2.0\",\"method\":\"bsc_getBlockByNumber\",\"params\":[\"latest\", false],\"id\":1}' http://localhost:8545"
...
echo ""
echo "   ⚠️  Reth's built-in APIs (may be stuck in sync mode):"
echo "     curl -X POST -H \"Content-Type: application/json\" --data '{\"jsonrpc\":\"2.0\",\"method\":\"eth_blockNumber\",\"params\":[],\"id\":1}' http://localhost:8545"
echo "     curl -X POST -H \"Content-Type: application/json\" --data '{\"jsonrpc\":\"2.0\",\"method\":\"eth_getBlockByNumber\",\"params\":[\"latest\", false],\"id\":1}' http://localhost:8545"
echo ""
echo "📄 Logs:"
